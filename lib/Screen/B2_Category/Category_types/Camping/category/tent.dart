...
class tent extends StatefulWidget {
  String idUser;
  tent({this.idUser});

  _tentState createState() => _tentState();
}

class _tentState extends State<tent> {
  ///
                ...
                Padding(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("event")
                          .where('category', isEqualTo: 'Camping')
                          .where('type', isEqualTo: 'Tent')
                          .snapshots(),
