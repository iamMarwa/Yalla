...
class allSwimming extends StatefulWidget {
  String idUser;
  allSwimming({this.idUser});

  _allSwimmingState createState() => _allSwimmingState();
}

class _allSwimmingState extends State<allSwimming> {
  ///
