...
class summitHiking extends StatefulWidget {
  String idUser;
  summitHiking({this.idUser});

  _summitHikingState createState() => _summitHikingState();
}

class _summitHikingState extends State<summitHiking> {
  ///
