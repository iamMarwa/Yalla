...
class longhiking extends StatefulWidget {
  String idUser;
  longhiking({this.idUser});

  _longhikingState createState() => _longhikingState();
}

class _longhikingState extends State<longhiking> {
  ///
