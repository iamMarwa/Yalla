...
class allGermany extends StatefulWidget {
  String idUser;
  allGermany({this.idUser});

  _allGermanyState createState() => _allGermanyState();
}

class _allGermanyState extends State<allGermany> {
  ///
