...
class performingArts extends StatefulWidget {
  String idUser;
  performingArts({this.idUser});

  _performingArtsState createState() => _performingArtsState();
}

class _performingArtsState extends State<performingArts> {
  ///
                ...
                Padding(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          ...
                          .where('type', isEqualTo: 'Performing Arts')
                          .snapshots(),
