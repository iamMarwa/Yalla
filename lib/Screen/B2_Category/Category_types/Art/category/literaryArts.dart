...
class literaryArts extends StatefulWidget {
  String idUser;
  literaryArts({this.idUser});

  _literaryArtsState createState() => _literaryArtsState();
}

class _literaryArtsState extends State<literaryArts> {
  ///
                ...
                Padding(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          ...
                          .where('type', isEqualTo: 'Literary Arts')
                          .snapshots(),
