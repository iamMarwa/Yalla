...
class culinaryArts extends StatefulWidget {
  String idUser;
  culinaryArts({this.idUser});

  _culinaryArtsState createState() => _culinaryArtsState();
}

class _culinaryArtsState extends State<culinaryArts> {
  ///
                ...
                Padding(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          ...
                          .where('type', isEqualTo: 'Culinary Arts')
                          .snapshots(),
