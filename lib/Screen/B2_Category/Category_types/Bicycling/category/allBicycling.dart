...
class allBicycling extends StatefulWidget {
  String idUser;
  allBicycling({this.idUser});

  _allBicyclingState createState() => _allBicyclingState();
}

class _allBicyclingState extends State<allBicycling> {
  ///
                ...
                Padding(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("event")
                          .where('category', isEqualTo: 'Bicycling')
                          .snapshots(),
