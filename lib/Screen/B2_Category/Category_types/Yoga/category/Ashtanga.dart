...
class Ashtanga extends StatefulWidget {
  String idUser;
  Ashtanga({this.idUser});

  _AshtangaState createState() => _AshtangaState();
}

class _AshtangaState extends State<Ashtanga> {
  ///
                ...
                Padding(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("event")
                          .where('category', isEqualTo: 'Yoga')
                          .where('type', isEqualTo: 'Ashtanga')
                          .snapshots(),
